...
BakedProbesRenderer::BakedProbesRenderer(toml::table &tomlConfig)
...
BakedProbesRenderer::~BakedProbesRenderer() {
...
void BakedProbesRenderer::init(const std::shared_ptr<ui::Window> &win) {
  window = win;
...
std::unordered_set<std::string> BakedProbesRenderer::getValidationLayers() {
...
void BakedProbesRenderer::createInstance() {
  using namespace vulkan;
...
void BakedProbesRenderer::createSurface() { vkSurface = vkInstance->createSurface(window); }

void BakedProbesRenderer::render() {
...
void BakedProbesRenderer::createDevices() {
...
void BakedProbesRenderer::createSwapchain() {
...
void BakedProbesRenderer::createTextures() {
...
void BakedProbesRenderer::createDescriptorPool() {
...
void BakedProbesRenderer::createPipeline() {
...
void BakedProbesRenderer::createCommands() {
...
void BakedProbesRenderer::recordCommands() {
...
void BakedProbesRenderer::createFences() {
...
void BakedProbesRenderer::createSemaphores() {
...
void BakedProbesRenderer::initUI() {
...
std::vector<std::filesystem::path> BakedProbesRenderer::loadModelFileNames(const std::filesystem::path &dir) {
...
void BakedProbesRenderer::stop() {
  for (auto &subscription : subscriptions) { subscription.unsubscribe(); }
  subscriptions.clear();
}

void BakedProbesRenderer::rebuildAndUploadBVH() {
...
void BakedProbesRenderer::duplicateModel(vox::GPUModelManager::ModelPtr original) {
...
void BakedProbesRenderer::instantiateModel(vox::GPUModelManager::ModelPtr original) {
  threadpool->enqueue([this, original] {
...
#include <fstream>
void BakedProbesRenderer::convertAndSaveSVO(const std::filesystem::path &src, const std::filesystem::path &dir) {
...
void BakedProbesRenderer::createBuffers() {
  cameraUniformBuffer =
