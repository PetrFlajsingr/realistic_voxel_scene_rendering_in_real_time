...
#ifndef REALISTIC_VOXEL_RENDERING_SRC_RENDERING_NAIVEVOXELRENDERER_H
#define REALISTIC_VOXEL_RENDERING_SRC_RENDERING_NAIVEVOXELRENDERER_H
...
namespace pf {
class NaiveVoxelRenderer : VulkanDebugCallbackImpl {
 public:
  explicit NaiveVoxelRenderer(toml::table &tomlConfig);
  NaiveVoxelRenderer(const NaiveVoxelRenderer &) = delete;
  NaiveVoxelRenderer &operator=(const NaiveVoxelRenderer &) = delete;
  NaiveVoxelRenderer(NaiveVoxelRenderer &&) = default;
  NaiveVoxelRenderer &operator=(NaiveVoxelRenderer &&) = default;
  virtual ~NaiveVoxelRenderer();
...
#endif//REALISTIC_VOXEL_RENDERING_SRC_RENDERING_NAIVEVOXELRENDERER_H
