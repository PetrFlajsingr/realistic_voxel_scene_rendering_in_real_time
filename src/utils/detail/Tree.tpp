...
template<typename T, unsigned int ChildCount>
Tree<T, ChildCount> Tree<T, ChildCount>::BuildTree(std::size_t depth, const_reference initValue) {
...
template<typename T, unsigned int ChildCount>
void Tree<T, ChildCount>::initChildren(Node<T, ChildCount> *node, const_reference initValue, std::size_t depth) {
...
template<typename T, unsigned int ChildCount>
Tree<T, ChildCount>::Tree(const Tree &other) {
...
template<typename T, unsigned int ChildCount>
Tree<T, ChildCount> &Tree<T, ChildCount>::operator=(const Tree &other) {
