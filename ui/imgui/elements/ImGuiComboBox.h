...
namespace pf::ui {
class ImGuiComboBox : public ImGuiCaptionedElement, public ImGuiValueObservableElement<std::string_view> {
 public:
  ImGuiComboBox(const std::string &elementName, const std::string &caption, std::string previewValue,
