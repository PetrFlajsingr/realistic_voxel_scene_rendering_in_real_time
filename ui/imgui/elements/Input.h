...
template<OneOf<IMGUI_INPUT_TYPE_LIST> T>
class Input : public LabeledElement, public ValueObservableElement<T> {
 ...
 protected:
  void renderImpl() override {
    ...
    if constexpr (std::same_as<T, float>) {
      ImGui::InputFloat(getLabel().c_str(), ValueObservableElement<T>::getValueAddress(),
    ...
    if constexpr (std::same_as<T, int>) {
      ImGui::InputInt(getLabel().c_str(), ValueObservableElement<T>::getValueAddress(),
